...
IntroState::IntroState(sf::RenderWindow &newWindow, tgui::Gui &newGui, b2World &newWorld, DebugDraw &newDebugDraw, Map &newMap):
StateBase(newWindow, newGui, newWorld, newDebugDraw, newMap, States::Id::INTRO_STATE)
{
    //ctor
